...
// Obtener información detallada del viaje desde MariaDB
...
// Obtener los puntos de recolección específicos de este viaje amarrados por idViaje
$queryPuntos = $conn->query("SELECT * FROM PuntosRecoleccion WHERE idViaje = $idViaje ORDER BY fechaCita ASC, horaCita ASC");
?>
...
<head>
    ...
    <style>
        ...
        /* Cabecera adaptiva para soportar fotografías o el degradado original de respaldo */
        .header-reserva { 
        ...
        /* Overlay oscuro para garantizar la perfecta legibilidad del texto blanco */
        ...
        input, select { width: 100%; padding: 12px; margin-top: 5px; border: 1px solid #ddd; border-radius: 8px; box-sizing: border-box; font-size: 14px; outline: none; }
        input:focus, select:focus { border-color: var(--morado-principal); }
...
<div class="container">
    ...
    <div class="detalles-viaje">
        <?php 
            // Control lógico de imágenes apuntando correctamente a la raíz /uploads
    ...
    <div class="formulario-reserva">
        ...
        <form action="procesar_reserva.php" method="POST" enctype="multipart/form-data">
            ...
            <input type="number" name="cantidad_boletos" id="cant_boletos" min="1" max="10" value="1" onchange="calcularTotal()" required>
